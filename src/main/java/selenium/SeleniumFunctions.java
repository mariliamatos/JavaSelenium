...
public abstract class SeleniumFunctions {
	...
	public void sendElemet(final WebElement element, String keysToSend) {
		try {
	...
	protected void waitToElementAndClick(final WebElement element) throws InterruptedException {
		try {
			waitForElement(element);
			final WebDriverWait wait = new WebDriverWait(this.driver, 1500);
